// Ali Faiyaz
// Part 1: Assignment 3 for Linear Probing
// In this file, we will implement the hash table using linear probing.
// For linear probing, it the same as quadratic probing but deleted one line which is offset += 2
...
// This class is used to create a hash table using linear probing 
// In this linear probing, the difference from quadratic is that offset += 2 was deleted because its linear
...
class LinearHashTable {
 public:
  ...
  explicit LinearHashTable(size_t size = 101) : array_(LinearNextPrime(size))
    { MakeEmpty(); }
